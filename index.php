...
<body>
 <?php
  if(isset($_POST['submit'])){
   $con = mysql_connect("mysql8.000webhost.com", "a5544266_ptt","22-Feb-2013");
   if(!$con){
    die('MySQL connection failed');
   }
 
   $db = mysql_select_db("a5544266_ptt");
   if(!$db){
   ...
   // Set POST variables
    ...
    $message = array("Notice" => $_POST['message']);
         ...
         $headers = array(
             'Authorization: key=AIzaSyD2qN1uRkqvFX_IGmEgwHnhPf57k8I4eOM',
